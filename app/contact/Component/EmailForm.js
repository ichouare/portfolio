...
const EmailForm = () => {
  return (
    <form className='text-white  w-full   flex flex-col  flex-wrap items-start justify-evenly gap-8    '>
        ...
        <input type="email"  placeholder="enter your email address" className="w-full md:w-[60%] border border-gray p-3 bg-black outline-0" />
        <textarea placeholder="Message" className='w-full md:w-[80%] h-[200px] bg-black border border-gray outline-0 p-2'></textarea>
